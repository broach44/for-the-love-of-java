...
class VisitForm extends React.Component {
  state = {
    ...
    newPrimaryVisitPurpose: '',
    newWifiImportanceRating: '',
    newDrinkImportanceRating: '',
    newFoodImportanceRating: '',
    newPricingImportanceRating: '',
    newTechImportanceRating: '',
    newEnvironmentImportanceRating: '',
  }
